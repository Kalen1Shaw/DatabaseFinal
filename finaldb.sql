...
-- Match Table
CREATE TABLE Matches (`MATCH_ID` INTEGER NOT NULL AUTO_INCREMENT,`HOME_TEAM` INTEGER NOT NULL, `AWAY_TEAM` INTEGER NOT NULL, `SCORE` VARCHAR(55),
 `DATE` DATE NOT NULL, `TIME` TIME NOT NULL, `RD1MODE` INTEGER NOT NULL, `RD2MODE` INTEGER NOT NULL, `RD3MODE` INTEGER,
 PRIMARY KEY(MATCH_ID),
 FOREIGN KEY(HOME_TEAM) REFERENCES Teams(TEAM_ID) ON UPDATE CASCADE ON DELETE CASCADE,
 FOREIGN KEY(AWAY_TEAM) REFERENCES Teams(TEAM_ID) ON UPDATE CASCADE ON DELETE CASCADE,
 FOREIGN KEY(RD1MODE) REFERENCES Mode(MODE_CODE) ON UPDATE CASCADE ON DELETE CASCADE,
 FOREIGN KEY(RD2MODE) REFERENCES Mode(MODE_CODE) ON UPDATE CASCADE ON DELETE CASCADE,
 FOREIGN KEY(RD3MODE) REFERENCES Mode(MODE_CODE) ON UPDATE CASCADE ON DELETE CASCADE);
